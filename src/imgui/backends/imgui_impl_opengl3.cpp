...
bool ImGui_ImplOpenGL3_InitLoader(const char* lib_filename);
bool ImGui_ImplOpenGL3_InitLoader(const char* lib_filename)
{
    ...
    if (glGetIntegerv == nullptr && imgl3wInit(lib_filename) != 0)
    {
...
// Functions
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version, const char* lib_filename)
{
    ...
    // Initialize loader
    if (!ImGui_ImplOpenGL3_InitLoader(lib_filename))
        return false;
...
void    ImGui_ImplOpenGL3_NewFrame()
{
    ...
    ImGui_ImplOpenGL3_InitLoader(NULL);
    if (!bd->ShaderHandle)
