...
// NOTE (2026-05-19): parallel image export currently seems to be functional and stable on Windows, macOS and Linux.
// Optionally disable using the toggle below:
bool disable_parallel_image_export = false;
